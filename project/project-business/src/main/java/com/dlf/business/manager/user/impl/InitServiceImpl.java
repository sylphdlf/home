...
import com.dlf.common.utils.db.DbUtils;
...
public class InitServiceImpl implements InitService {
    ...
    public void initSource() {
        ...
        for(Map.Entry<String, List<FunDTO>> thisEntry : entries){
            ...
            function.setName(thisEntry.getKey());
            function.setCode(codeLevel1);
            function.setParentCode("0");
            ...
            if(!CollectionUtils.isEmpty(menuList)){
                for(FunDTO thisDTO : menuList){
                    ...
                    //二级菜单
                    Function menuLevel2 = new Function();
                    ...
                    if(!CollectionUtils.isEmpty(thisDTO.getChildren())){
                        for(FunDTO thisSourceDTO : thisDTO.getChildren()){
                            ...
                            //资源
                            Function menuLevel3 = new Function();
...
//    @RedisCacheAnno(key=IRedisPrefixEnums.menu_list, timeout = 900)
    ...
    private Set<String> getCurrentSourceSet(){
        ...
        //查询所有的一级菜单，通过名称 判断重复
        Function level1Select = new Function();
        ...
        Function level2Select = new Function();
        ...
        //查询所有的资源，通过path 判断重复
        Function sourceSelect = new Function();
