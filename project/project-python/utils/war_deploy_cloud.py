...
ssh = None
# 项目地址
project_root_path = "/data/code/office2/project"
# tomcat地址
project_tomcat_path = ["/data/code/springboot-jar"]
# project_tomcat_path = ["/data/tomcat/tomcat-9.0.12-8081", "/data/tomcat/tomcat-9.0.12-8082"]
# war包原始名称
source_war_name = ["project-eureka-1.0-SNAPSHOT.jar", "project-zuulGateway-1.0-SNAPSHOT.jar"]
# 项目war包名称
target_war_name = ["project-eureka.jar", "project-zuulGateway.jar"]
# 原包路径
source_war_path = project_root_path + "/project-eureka/target/" + "project-eureka-1.0-SNAPSHOT.jar"
source_war_path2 = project_root_path + "/project-zuulGateway/target/" + "project-zuulGateway-1.0-SNAPSHOT.jar"
