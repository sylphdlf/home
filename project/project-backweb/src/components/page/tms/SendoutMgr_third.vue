    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i> 外发管理</el-breadcrumb-item>
                <el-breadcrumb-item>送出外发</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" label-width="100px" :inline="true">
                <div class="handle-box" align="center">
                    <el-form-item prop="driverName">
                        <el-input placeholder="送货司机" v-model="ruleForm.driverName">
                            <template slot="prepend"><el-button icon="el-icon-search" @click="openDriverWin"></el-button></template>
                        </el-input>
                    </el-form-item>
                    <el-form-item prop="consignorTel">
                        <el-input placeholder="送货车牌号" class="handle-input" v-model="ruleForm.vehicleNumber"></el-input>
                    </el-form-item>
                    <el-form-item prop="consignorTel">
                ...
                <div class="handle-box" align="center">
                    <el-form-item prop="consignorTel">
                        <el-date-picker v-model="ruleForm.pickupTime" type="datetime" placeholder="送出时间" class="handle-input"></el-date-picker>
                    </el-form-item>
                    <el-form-item prop="consignorTel">
                        <el-input placeholder="送出成本合计" class="handle-input" v-model="ruleForm.price"></el-input>
                    </el-form-item>
                    <el-form-item prop="consignorTel">
                        <el-input placeholder="送货备注" class="handle-input" v-model="ruleForm.remarks"></el-input>
                    </el-form-item>
                </div>
            </el-form>
            <div class="handle-box" align="center">
